  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative bg-[#F5F7FB]">
      ...
      <div className="w-full max-w-md p-8 rounded-3xl bg-white border border-[#E2E8F0] relative z-10 space-y-8 shadow-xl shadow-slate-100/50">
        ...
        <div id="googleRenderContainer" className="flex justify-center w-full min-h-[44px]">
          {/* Fallback button if Google script is loading or offline */}
          {(!process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID || typeof window === 'undefined' || !window.google?.accounts) && (
            <button
              type="button"
