                  ...
                  >
                    ...
                    <div className="p-4 sm:p-5 flex flex-col flex-grow space-y-3">
                      <div className="space-y-1">
                        ...
                        <h3 className="text-slate-900 dark:text-white font-extrabold text-lg group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                          {project.title}
                        </h3>
                        {project.subtitle && (
                      ...
                      <div className="flex flex-wrap gap-1.5 pt-2 border-t border-slate-200 dark:border-slate-800">
                        {project.tags.slice(0, 3).map((tag) => (
                          <span
                            key={tag}
                            className="px-2.5 py-0.5 bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-md text-[10px] text-slate-700 dark:text-slate-300 font-mono font-medium"
                          >
                            {tag}
                          </span>
                        ))}
                        {project.tags.length > 3 && (
                          <span className="px-2 py-0.5 bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-md text-[10px] text-slate-500 dark:text-slate-400 font-mono font-medium">
                      ...
                      <div className="flex sm:hidden items-center justify-between gap-2 pt-3 border-t border-slate-200 dark:border-slate-800">
                        <button
                          onClick={() => setSelectedProject(project)}
                          className="flex-1 py-2 px-3 bg-blue-600 text-white rounded-xl text-xs font-bold flex items-center justify-center space-x-1 shadow-sm cursor-pointer"
                        >
                        ...
                        {project.demoLink && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-2 bg-emerald-500 text-white rounded-xl flex items-center justify-center cursor-pointer"
                          >
