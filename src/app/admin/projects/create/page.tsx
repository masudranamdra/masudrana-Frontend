        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-black text-white tracking-tight flex items-center gap-2">
              ...
              <span>Create New Project (নতুন প্রজেক্ট যুক্ত করুন)</span>
            </h1>
            <p className="text-xs text-slate-400 mt-0.5">
              প্রজেক্টের কভার ফটো, কেস স্টাডি গ্যালারি, এবং প্রফেশনাল ফরম্যাটেড বিবরণ যুক্ত করুন।
            </p>
          </div>
        </div>
          ...
          >
            {formLoading ? (
              ...
              <>
                ...
                <span>Save Project (সংরক্ষণ করুন)</span>
              </>
            )}
          </button>
        </div>
