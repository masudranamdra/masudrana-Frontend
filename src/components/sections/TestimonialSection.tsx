...
export const TestimonialSection: React.FC = () => {
  ...
  return (
    <section id="testimonials" className="relative py-10 sm:py-12 bg-[#F5F7FB] dark:bg-[#0F172A] text-[#0F172A] dark:text-white border-t border-b border-[#E2E8F0] dark:border-slate-800 overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center mb-8">
          <button
            ...
            className="inline-flex items-center space-x-2 px-5 py-2.5 rounded-xl font-bold bg-[#2563EB] hover:bg-blue-600 text-white shadow-sm transition-all text-xs sm:text-sm cursor-pointer hover:scale-[1.01] active:scale-[0.99]"
          >
        ...
        {testimonials.length > 0 ? (
          <div className="relative max-w-4xl mx-auto">
            {/* Quote Icon */}
            <div className="absolute -top-8 -left-4 text-[#2563EB]/10 dark:text-blue-400/10 pointer-events-none z-0">
            ...
            <motion.div
              ...
              className="relative z-10 p-6 sm:p-8 rounded-xl bg-white dark:bg-slate-900 border border-[#E2E8F0] dark:border-slate-800 shadow-sm flex flex-col items-center text-center space-y-6"
            >
